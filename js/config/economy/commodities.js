...
const COMMODITY_REGISTRY = Object.freeze({
    ...
    water_ice: withDefaults({ id: 'water_ice', name: 'Water Ice', category: 'raw', tier: 'raw', bulk: 3, basePrice: 45, volatility: 0.18, primarySources: Object.freeze(['ice_harvest']), primaryConsumers: Object.freeze(['life_support', 'coolant_plants']) }),
    org: withDefaults({ id: 'org', name: 'Biomass', category: 'raw', tier: 'raw', bulk: 2, basePrice: 65, volatility: 0.22, primarySources: Object.freeze(['hydroponics', 'agri_outposts']), primaryConsumers: Object.freeze(['polymer_plants', 'fertilizer_plants']) }),
    ...
    eq: withDefaults({ id: 'eq', name: 'Equipment', category: 'manufactured', tier: 'manufactured', basePrice: 240, inputs: Object.freeze({ machinery: 1, electronics: 1 }), primaryConsumers: Object.freeze(['captains', 'colonies']), isFinishedGood: true }),
    machinery: withDefaults({ id: 'machinery', name: 'Machinery', category: 'manufactured', tier: 'manufactured', basePrice: 210, inputs: Object.freeze({ refined_metals: 1, electronics: 1 }), primaryConsumers: Object.freeze(['industry']), isFinishedGood: true }),
    ...
    electronics: withDefaults({ id: 'electronics', name: 'Electronics', category: 'manufactured', tier: 'manufactured', basePrice: 200, inputs: Object.freeze({ heavy_metals: 1, rare_earths: 1 }), primaryConsumers: Object.freeze(['stardocks', 'gates']), isFinishedGood: true }),
    medical_supplies: withDefaults({ id: 'medical_supplies', name: 'Medical Supplies', category: 'manufactured', tier: 'manufactured', basePrice: 210, inputs: Object.freeze({ polymers: 1, water_ice: 1 }), primaryConsumers: Object.freeze(['population_centers']), isFinishedGood: true }),
    construction_kits: withDefaults({ id: 'construction_kits', name: 'Construction Kits', category: 'manufactured', tier: 'manufactured', basePrice: 260, inputs: Object.freeze({ refined_metals: 1, machinery: 1 }), primaryConsumers: Object.freeze(['expansion_projects']), isFinishedGood: true }),
    pulse_canister: withDefaults({ id: 'pulse_canister', name: 'Pulse Canisters', category: 'pulse', tier: 'pulse', basePrice: 320, volatility: 0.35, inputs: Object.freeze({ water_ice: 1, coolants: 1 }), primaryConsumers: Object.freeze(['way_stations', 'gate_hubs']), isFinishedGood: true }),
    heavy_pulse_module: withDefaults({ id: 'heavy_pulse_module', name: 'Heavy Pulse Modules', category: 'pulse', tier: 'pulse', basePrice: 420, inputs: Object.freeze({ pulse_canister: 1, machinery: 1 }), isFinishedGood: true }),
    gate_coils: withDefaults({ id: 'gate_coils', name: 'Gate Coils', category: 'pulse', tier: 'pulse', basePrice: 460, inputs: Object.freeze({ heavy_metals: 1, electronics: 1 }), isFinishedGood: true }),
    control_cores: withDefaults({ id: 'control_cores', name: 'Control Cores', category: 'pulse', tier: 'pulse', basePrice: 500, inputs: Object.freeze({ electronics: 1, rare_earths: 1 }), isFinishedGood: true })
});
